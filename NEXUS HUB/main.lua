...
-- Create UI Elements
local LevelLabel = MainTab:CreateLabel("Current Level: " .. (game:GetService("Players").LocalPlayer.Data.Level.Value or "Loading..."))
local CurrentQuestLabel = MainTab:CreateLabel("Current Quest: None")
local TargetMonsterLabel = MainTab:CreateLabel("Target Monster: None")
local QuestLocationLabel = MainTab:CreateLabel("Quest Location: None")
local MonsterLocationLabel = MainTab:CreateLabel("Monster Location: None")
...
local function UpdateUI()
    ...
    LevelLabel:Set("Current Level: " .. MyLevel)
    CurrentQuestLabel:Set("Current Quest: " .. (NameQuest or "None"))
    TargetMonsterLabel:Set("Target Monster: " .. (NameMon or "None"))
    QuestLocationLabel:Set("Quest Location: " .. tostring(CFrameQuest and CFrameQuest.Position or "None"))
    MonsterLocationLabel:Set("Monster Location: " .. tostring(CFrameMon and CFrameMon.Position or "None"))
end
...
local AutoUpdateToggle = MainTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            spawn(function()
                while AutoUpdateToggle.CurrentValue do
                    UpdateUI()
                    wait(1)
                end
            end)
...
SettingsTab:CreateInput({
    Name = "Walk Speed",
    PlaceholderText = "Current: " .. game.Players.LocalPlayer.Character.Humanoid.WalkSpeed,
...
SettingsTab:CreateInput({
    Name = "Jump Power",
    PlaceholderText = "Current: " .. game.Players.LocalPlayer.Character.Humanoid.JumpPower,
    RemoveTextAfterFocusLost = false,
    Callback = function(Text)
        local num = tonumber(Text)
        if num then
